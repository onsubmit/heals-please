...
// Every 10 seconds, he gores one party member with his long tusk, damaging them between 24-42.
// Gored party members will bleed for 4 damage every second until healed to full.
// Every 15 seconds, he will stomp his feet, silencing the player if they are casting.
...
export default class ElongTusk extends Boss {
  ...
  constructor(
    ...
    super(100000, player, tank, raid, onDeathCallback);
    ...
    this.loops = new Loops(
      ...
      new Loop("Gore", this._gore, 10000)
    );
